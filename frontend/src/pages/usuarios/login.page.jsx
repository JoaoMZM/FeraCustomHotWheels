...
// Importando o serviço de login do seu arquivo de API
...
export default function LoginPage({ onNavigateToCadastro, onNavigateToRecuperarSenha }) {
    const [formData, setFormData] = useState({ authMethod: '', senha: '' });
    ...
    const handleSubmit = async (e) => {
        ...
        if (!formData.authMethod || !formData.senha) {
            setErro('Por favor, preencha todos os campos.');
            return;
        }
        
        const emailRegex = /^[^\s@]+@[^\s@]+\.[^\s@]+$/;
        if (!emailRegex.test(formData.authMethod)) {
        ...
        try {
            ...
            // Como a sua api.js faz um "throw new Error(data.message)", o erro cai aqui
    ...
    const IconeEmail = () => (
        <svg className="input-icon" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
            ...
            <form onSubmit={handleSubmit} noValidate>
                ...
                <div className="form-group">
                    ...
                    <div className="input-wrap">
                        ...
                        <input
                            ...
                            autoComplete="email"
                            className={`input-com-icone ${erro && !formData.authMethod ? 'input-erro' : ''}`.trim()}
                        />
                    </div>
                </div>
                ...
                <div className="form-group">
                    <div className="senha-row">
                        <label htmlFor="login-senha" style={{ marginBottom: 0 }}>Senha</label>
                        <button 
                            type="button" 
                    ...
                    <div className="input-wrap">
                        ...
                        <input
                            ...
                            className={`input-com-icone input-com-toggle ${erro && !formData.senha ? 'input-erro' : ''}`.trim()}
                        />
                        <button
                            type="button"
