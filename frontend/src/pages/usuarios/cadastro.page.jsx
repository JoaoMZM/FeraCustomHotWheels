...
// ── Ícones SVG ──────────────────────────────────────────────────────────────
// Ficam fora do componente: assim mantêm a mesma identidade de função entre
// renders e o React não remonta o DOM a cada tecla digitada.
...
// ── Campo reutilizável ──────────────────────────────────────────────────────
// Também fora do componente, recebendo value/onChange/erro via props em
// vez de depender do escopo (closure) de CadastroPage.
...
export default function CadastroPage() {
    // ⚠️ Hooks (useState, useNavigate) SEMPRE dentro do corpo do componente.
        ...
        <div className="cadastro-container">
            ...
            <form onSubmit={handleSubmit} noValidate>
                ...
                <CampoTexto
                    ...
                    onChange={handleChange}
                    erro={camposComErro.confirmarSenha}
                />
